class Game {
    ...
    set rating(value) {
        this._rating = value;
        this.ratingElement.innerHTML = 'Счёт: ' + value;
    }
    ...
    //Обходим все ячейки в противоположном направлении от нажатия клавиш
    //По направлению первую строку или столбец пропускаем
    //Для ячейки ищем следующую занятую ячейку(или послденюю)
    //Если ячейка занята и совпадает с нашей, то объединяем
    //Если ячейка занята и не совпадает с нашей, то проверяем предыдущую ячейку
